...
import { editar } from '../../../redux/slice/mantenimientos/marcaSlice';
...
export const MarcaGrilla = () => {

    //----usando el hook  redux
  const dispatch = useDispatch();
  const { marcasVehiculosCab } = useSelector(state => state.mant_marcaVehiculo);
  ...
  const columns = [
    { field: 'id_Marca', headerName: 'ID', width: 120 },
