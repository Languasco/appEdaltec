...
import { nuevo, mostrarInformacion } from '../../../redux/slice/mantenimientos/marcaSlice';
...
export const MarcaFiltros = () => {
  ...
  return (    
    <Card> 
        <CardContent>
        <div>
                <p className='titleFormAlternative'>  MANTENIMIENTO MARCA DE VEHICULO  </p>
            </div>
