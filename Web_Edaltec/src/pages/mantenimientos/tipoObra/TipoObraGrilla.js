...
export const TipoObraGrilla = () => {
  ...
  const columns = [
    { field: 'id_TipoTrabajo', headerName: 'ID', width: 120 },
    { field: 'descripcion_TipoTrabajo', headerName: 'DESCRIPCION ', width: 200 },
    { field: 'abreviatura_TipoTrabajo', headerName: 'ABREVIATURA', width: 120 },
