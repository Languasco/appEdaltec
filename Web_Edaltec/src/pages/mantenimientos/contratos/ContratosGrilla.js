...
import { editar } from '../../../redux/slice/mantenimientos/contratoSlice';
...
export const ContratosGrilla = () => {

    //----usando el hook  redux
  const dispatch = useDispatch();
  const { contratosCab } = useSelector(state => state.mant_contrato);
    //  //----- notificaciones-----
  ...
  const columns = [
    { field: 'id_Contrato', headerName: 'ID', width: 120 },
    { field: 'nombre_Cliente', headerName: 'CLIENTE ', width: 250 },
    { field: 'numero_Contrato', headerName: 'NRO CONTRATO', width: 200 },
    { field: 'observaciones_Contrato', headerName: 'DESCRIPCION', width: 250 },
