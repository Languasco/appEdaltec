...
import { mostrarInformacion, nuevo } from '../../../redux/slice/mantenimientos/contratoSlice';
...
export const ContratosFiltros = () => {
  ...
  return (    
    <Card> 
        <CardContent>
            <div>
                <p className='titleFormAlternative'>  MANTENIMIENTO DE CONTRATOS </p>
            </div>
